...
public class SqsPollerApp {
  ...
  private final ConsolidateWorker consolidateWorker;
  
  public SqsPollerApp(String queueUrl, ConsolidateWorker consolidateWorker) {
    this.sqsClient = SqsClient.builder().build();
    this.queueUrl = queueUrl;
    this.consolidateWorker = consolidateWorker;
  }
  ...
  private boolean processMessage(Message message) {
    try {
      ...
      consolidateWorker.run(bucketName, objectKey);
